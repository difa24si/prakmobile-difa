package com.example.dipaflower.Message.tutorial
...
import com.example.dipaflower.databinding.ActivityTutorialMessageBinding
...
class TutorialMessageActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.tutorialMessageViewPager.adapter =
            adapter

        binding.dotIndicator.attachTo(
            binding.tutorialMessageViewPager
        )
    }
}